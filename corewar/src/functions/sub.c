...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/03/07 12:05:24 by ttridon           #+#    #+#             */
/*   Updated: 2017/04/05 16:25:20 by ttridon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "vm.h"

int		cw_sub(unsigned char *arena, t_process *process, t_game *game)
{
	int		params[MAX_ARGS_NUMBER];
	int		oct_codage;

	if (cooldown(process, SUB_COOLDOWN) && game)
		return (0);
